...
interface IFlySwatVars extends VariableType {
	
}
interface IFlySwatBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IFlySwat extends ISpriteInstance {
	instVars: IFlySwatVars;
	behaviors: IFlySwatBehaviors;
}
